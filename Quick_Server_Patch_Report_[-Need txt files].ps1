...
$ServerList = Get-Content $ScriptPath\6322wpd.txt
...
ForEach ($Server in $ServerList)
{
    ...
    Catch 
    {
        $ServerLastUpdate = (Get-HotFix -ComputerName $Server | Sort-Object -Descending -Property InstalledOn -ErrorAction SilentlyContinue | Select-Object -First 3)
